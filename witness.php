    ...
    function renderPage(index) {
        ...
        if (page.type === 'video') {
            html = `
                ...
                <p style="text-align:center; color:rgba(255,255,255,0.6); margin-top:20px;">点击播放，接收来自林老师的祝福( •̀ ω •́ )✧<br/>（如果你发现很卡 这非常正常 因为采用的是境外CDN服务）</p>
            `;
        } else {
            html = `
