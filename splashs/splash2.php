...
<body>
    ...
    <div class="splash-container">
        ...
        <div class="line" id="line1">这是一份“11班终极认证测试”</div>
        <div class="line" id="line2">四面八方、纵横领域的日常与观察</div>
        <div class="line" id="line3">让同在的时光，凝练于字里行间</div>
        <div class="line" id="line4">题干与选项本身便承载着回忆</div>
        <div class="line" id="line5">而答案正藏在11班的各个角落，每分每秒</div>
        <div class="line" id="line6">准备好了吗？</div>
        <div class="line special" id="line7">11班终极认证测试</div>
        <div class="footer-note" id="footer">
            <div class="back-link">
                <a href="/../passwordForNewYear.php">✨ 现在开始！ ✨</a>
            </div>
        </div>
    </div>
        <script>
